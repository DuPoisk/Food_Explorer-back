// validando usuário cadastrado st10.1.3
const knex = require("../database/knex"); // conexão com o banco de dados
const AppError = require("../utils/AppError"); // para validar se usuário existe. AppError para lidar com as exceções
...
class SessionsController {
  async create(request, response){ //assíncrona, pois envolve conexão com banco de dados. crio aqui uma sessão para o usuário.
    ...
    const {secret, expiresIn} = authConfig.jwt; // st10.1.7
