//ARQUIVO DE CONFIGURAÇÕES DO UPLOAD QUE UTILIZAREMOS NA APLICAÇÃO st10.2.1

const path = require("path");
const multer = require("multer"); //biblioteca para fazer o upload de imagens
const crypto = require("crypto"); // usarei crypto para criar um hash, cujo objetivo é evitar arquivos com nomes iguais
